				...
				<div className="flex flex-wrap flex-grow mt-8 text-left md:mt-0 ">
					...
					<div className="w-full px-8 md:w-1/4 ">
						...
						<nav className="mb-10 space-y-4 list-none">
							<li>
								<Link to={'/'} className="cursor-pointer mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2">Home</Link>
							</li>
							<li>
								<Link to={'/'} className="cursor-pointer mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2">About</Link>
							</li>
						</nav>
					</div>
					<div className="w-full px-8 md:w-1/4">
						<span className="inline-flex justify-start sm:mb-12">
							<Link to={'/'} className="dark:text-blue-500 hover:text-gray-900 dark:hover:text-black">
								<svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5"
									viewBox="0 0 24 24">
									<path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
								</svg>
							</Link>
							<Link to={'/'} className="ml-3 dark:text-blue-500 hover:text-gray-900 dark:hover:text-black">
								<svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5"
									viewBox="0 0 24 24">
									<path
